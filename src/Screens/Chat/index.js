...
const DATA_MESSAGES=[
    {id:0,frnName:'Rosinaldo',chats:[
      {id:1,text:'Olá',sender:'Rosinaldo',},
      {id:1,text:'Oi',sender:'Me',},
      {id:1,text:'Como você está?',sender:'Rosinaldo',},
      {id:1,text:'Muito bem e vc?',sender:'Me',},
      {id:1,text:'Estou Otimo',sender:'Rosinaldo',},
  ...
  const headerComponent=()=>(
    <View style={{flex:1,backgroundColor:'#424242'}}>
          <View style={[{paddingBottom:20},styles.bdbtm4,styles.bdGrey,styles.pdlt10,styles.pdrt10,styles.frow,styles.jspaceBw]}>
            <View>
              <Text style={{fontSize:22,fontWeight:'bold', alignItems:"center"}}>Rosinaldo</Text>
