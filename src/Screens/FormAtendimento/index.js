...
const schema = yup.object({
    ...
    categoria: yup.string().min(3,"Categoria").required("Informe a categoria"),
   previa: yup.string().min(10,"Escrev uma previa do seu problema").required("Informe a Previa"),
})
...
<Controller
            ...
            <Controller
              ...
              <TextInput
              style={[styles.input, {
                borderWidth: errors.categoria && 1,
          ...
          <TouchableOpacity style={styles.btnAcessar}>
            <Text style={styles.btnTextoAcessar} onPress={handleSubmit(handleSignIn)}>Solicitar Já</Text>
          </TouchableOpacity>
